<template>
    <div class="grid md:flex md:flex-wrap  justify-beetwen items-center gap-6 m-[20px]">
        <div class="md:w-[48%] lg:w-[32%] bg-gradient-to-r from-[#34BCA2] to-[#1A16E9] p-0.5 rounded-lg">
            <div class="md:w-[100%] lg:w-[100%] bg-[#060647] rounded-lg  flex gap-6 p-2">
                <img src="../assets/images/svgs/1.svg" alt="" class="pl-[15px] pb-[20px] md:pb-[150px] lg:pb-[80px]">
                <div class=" text-white h-auto md:h-[230px] lg:h-[155px]">
        ...
        <div class="md:w-[48%] lg:w-[32%] bg-gradient-to-r from-[#34BCA2] to-[#1A16E9] p-0.5 rounded-lg">
            <div class="md:w-[100%] lg:w-[100%] bg-[#060647] rounded-lg  flex gap-6 p-2">
                <img src="../assets/images/svgs/2.svg" alt="" class="pl-[15px] pb-[5px] md:pb-[150px] lg:pb-[80px]">
                <div class=" text-white h-auto md:h-[230px] lg:h-[155px]">
        ...
        <div class="md:w-[48%] lg:w-[32%] bg-gradient-to-r from-[#34BCA2] to-[#1A16E9] p-0.5 rounded-lg">
            <div class="md:w-[100%] lg:w-[100%] bg-[#060647] rounded-lg  flex gap-6 p-2">
                <img src="../assets/images/svgs/3.svg" alt="" class="pl-[15px] pb-[25px] md:pb-[150px] lg:pb-[80px]">
                <div class=" text-white h-auto md:h-[230px] lg:h-[155px]">
        ...
        <div class="md:w-[48%] lg:w-[32%] bg-gradient-to-r from-[#34BCA2] to-[#1A16E9] p-0.5 rounded-lg">
            <div class="md:w-[100%] lg:w-[100%] bg-[#060647] rounded-lg  flex gap-6 p-2">
                <img src="../assets/images/svgs/4.svg" alt="" class="pl-[15px] pb-[25px] md:pb-[150px] lg:pb-[80px]">
                <div class=" text-white h-auto md:h-[230px] lg:h-[155px]">
        ...
        <div class="md:w-[48%] lg:w-[32%] bg-gradient-to-r from-[#34BCA2] to-[#1A16E9] p-0.5 rounded-lg">
            <div class="md:w-[100%] lg:w-[100%] bg-[#060647] rounded-lg  flex gap-6 p-2">
                <img src="../assets/images/svgs/5.svg" alt="" class="pl-[15px] pt-[10px] md:pb-[150px] lg:pb-[80px]">
                <div class=" text-white h-auto md:h-[230px] lg:h-[155px]">
