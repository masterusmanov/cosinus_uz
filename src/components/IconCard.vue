<template>
    <div class="grid md:flex md:flex-wrap  justify-beetwen items-center gap-6 m-[20px]">
        <div class="md:w-[48%] lg:w-[32%] border border-[#34B8A3] rounded-lg  flex gap-6 p-2">
            <img src="../assets/images/svgs/1.svg" alt="" class="pl-[20px] pb-[50px] md:pb-[100px] lg:pb-[110px]">
            <div class=" text-white h-[120px] md:h-[190px]">
